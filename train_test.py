...
# To run the train_test, you must modify the algorithm name here. It must be one of diy, dqn.
# Simply modify the value of the algorithm_name variable.
# 运行train_test前必须修改这里的算法名字, 必须是diy、dqn里的一个, 修改algorithm_name的值即可
algorithm_name_list = ["diy", "dqn"]
algorithm_name = "dqn"
